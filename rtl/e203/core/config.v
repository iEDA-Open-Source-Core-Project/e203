...
`define E203_CFG_CLINT_ADDR_BASE  `E203_CFG_ADDR_SIZE'h0200_0000
    // (32-1:32-16)-->(31:16) 即地址高 16 位 --> (32'h0200_0000 : 32'h0200_ffff) 分配给CLINT
...
`define E203_CFG_PLIC_ADDR_BASE  `E203_CFG_ADDR_SIZE'h0C00_0000
    // (32-1:32-8)-->(31:24) 即地址高 8 位 --> (32'h0c00_0000 : 32'h0cff_ffff) 分配给PLIC
...
`define E203_CFG_FIO_ADDR_BASE  `E203_CFG_ADDR_SIZE'hf000_0000 
    // (32-1:32-4)-->(31:28) 即地址高 4 位 --> (32'hf000_0000 : 32'hffff_ffff) 分配给FIO
...
// `define E203_CFG_HAS_NICE //  leesum

...
// rid wid and bid are not used by icb2axi
// because we only have one master and one slave, so we do not care about rid wid and bid
sirv_gnrl_icb2axi # (
  ...
  assign  axi_arid = 'd0;               // force awid to 0

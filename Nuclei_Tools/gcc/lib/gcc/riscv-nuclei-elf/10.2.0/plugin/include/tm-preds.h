/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/Local/xl_ci/toolchain/riscv-gnu-toolchain/riscv-gcc/gcc/config/riscv/riscv.md'.  */
...
extern int imm5_operand (rtx, machine_mode);
...
{
  if (c >= CONSTRAINT_Wsa && c <= CONSTRAINT_C16)
    return;

...
#endif
#ifdef GENERATOR_FILE
extern int riscv_rvv_subext;
#else
  int x_riscv_rvv_subext;
#define riscv_rvv_subext global_options.x_riscv_rvv_subext
#endif
#ifdef GENERATOR_FILE
extern int riscv_zfh_subext;
#else
  int x_riscv_zfh_subext;
#define riscv_zfh_subext global_options.x_riscv_zfh_subext
#endif
#ifdef GENERATOR_FILE
